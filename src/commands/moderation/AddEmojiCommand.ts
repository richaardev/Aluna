  ...
  constructor(client: AlunaClient) {
    super(client, {
      ...
      parameters: [
        {
          errorMessage:
            "é necessário que informe o __**nome**__ que deseja colocar ao emoji!! Tente novamente.",
        },
        {
          errorMessage:
            "e também é necessário que coloque o **__emoji__** que deseja adicionar ao Servidor! T",
        },
      ],
    });
  }
